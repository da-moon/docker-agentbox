...
readonly package_file="${flake_dir}/packages/codex/default.nix"
...
x86_url="https://github.com/openai/codex/releases/download/${latest_tag}/codex-x86_64-unknown-linux-musl-bundle.tar.zst"
arm_url="https://github.com/openai/codex/releases/download/${latest_tag}/codex-aarch64-unknown-linux-musl-bundle.tar.zst"
...
if [ "$no_build" = false ]; then
  verify_package_build "$flake_dir" codex
fi

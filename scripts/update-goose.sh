...
readonly package_file="${repo_root}/nix/packages/goose.nix"
...
x86_url="https://github.com/block/goose/releases/download/v${latest_version}/goose-x86_64-unknown-linux-gnu.tar.gz"
arm_url="https://github.com/block/goose/releases/download/v${latest_version}/goose-aarch64-unknown-linux-gnu.tar.gz"
...
if [ "$no_build" = false ]; then
  verify_package_build "$repo_root" goose
fi
